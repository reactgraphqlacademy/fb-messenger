...
1. Implement the following route [http://localhost:3000/profile](http://localhost:3000/profile) so it renders src/components/Profile.js. Hint, you need to edit 2 files:
    ...
    2. The second file is src/components/Layout/TopBar.js, edit the &lt;Link&gt; so when the user clicks on the Link it navigates to /profil. [Link documentation](https://reacttraining.com/react-router/web/api/Link)
